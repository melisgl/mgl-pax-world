...
- [glossary-term] **definition**
    ...
    and [`dref-locative-type`][a22ed] but different [`dref-locative-args`][0976].
...
- [glossary-term] **locative type**
    ...
    Also, see [`locative-type`][97ba], [`xref-locative-type`][840e], [`dref-locative-type`][a22ed],
...
- [function] **definitions** *name &key (dtype t) (sort t)*
    ...
    Similarly, [`dref-locative-type`][a22ed] may be more made more specific:
...
- [function] **arglist** *object*
    ...
    This function supports [`macro`s][f3cca],
...
- [function] **docstring** *object*
    ...
    in purpose to `cl:documentation`([`0`][c5ae] [`1`][68f1]).
...
- [locative] **symbol-macro**
    ...
    defines methods on the `documentation`([`0`][c5ae] [`1`][68f1]) generic function specialized on
...
- [locative] **condition**
    ...
    Whenever a `class` denotes a `condition`, its [`dref-locative-type`][a22ed] will be
    `condition`:
...
methods of generic functions with [`eql` specializers][29a1d] for
...
- [variable] **\*check-locate\*** *nil*
    ...
    - If a `dref` is returned, then its [`dref-locative-type`][a22ed] must be
...
- [class] **macro-dref** *[dref][d930]*
    ...
    [`dref-ext:dref-class`][25be] of [`mgl-pax:macro`][f3cca].
...
- [macro] **this-source-location**
  ...
  [12814]: #DREF:DEFSTRUCT*%20MGL-PAX:MACRO "DREF:DEFSTRUCT* MGL-PAX:MACRO"
  ...
  [29a1d]: http://www.lispworks.com/documentation/HyperSpec/Body/07_fb.htm "\"7.6.2\" (MGL-PAX:CLHS MGL-PAX:SECTION)"
  ...
  [a22ed]: #DREF:DREF-LOCATIVE-TYPE%20FUNCTION "DREF:DREF-LOCATIVE-TYPE FUNCTION"
  ...
  [cc049]: #DREF:DREF-LOCATIVE%20%28MGL-PAX:READER%20DREF:DREF%29 "DREF:DREF-LOCATIVE (MGL-PAX:READER DREF:DREF)"
  ...
  [f3cca]: #MGL-PAX:MACRO%20MGL-PAX:LOCATIVE "MGL-PAX:MACRO MGL-PAX:LOCATIVE"
